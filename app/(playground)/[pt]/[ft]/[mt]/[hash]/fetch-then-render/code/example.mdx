...
詳細な実装は<font color="blue">[ GitHub ](<https://github.com/FAL-coffee/fetch-and-render-playground/blob/main/app/(playground)/[pt]/[ft]/[mt]/[hash]/fetch-then-render/%40example/page.tsx>)</font>を参照ください
...
Colocation を利用し、loadingUI を表示する場合は以下のようなファイルを追加する

```tsx app/(playground)/[pt]/[ft]/[mt]/[hash]/fetch-then-render/@example/loading.tsx
import { Profile } from "@/app/(playground)/_components/Profile";
import { FollowerList } from "@/app/(playground)/_components/FollowerList";
import { MessageList } from "@/app/(playground)/_components/MessageList";
import { FetchControl } from "@/app/(playground)/_components/FetchControl";
...
export default async function Loading() {
  return (
    <div>
      <FetchControl isDisabled />

      <div className="my-2">
        <FetchAndRenderTimingInfo isLoading />
      </div>
